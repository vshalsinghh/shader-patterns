...
void main()
{
    ...
    //pattern 27
    //  float strength = 0.02 / distance(vUv, vec2(0.5) ) + 0.25;
    ...
    //pattern 48
    float strength = step(0.4, sin(cnoise(vUv * 10.0 )* 20.0 ) );


    strength = clamp( strength, 0.0, 1.0);
    vec3 blackColor = vec3(0.0);
    vec3 uvColor = vec3(vUv, sin(vTime * 0.02) * 2.0);
